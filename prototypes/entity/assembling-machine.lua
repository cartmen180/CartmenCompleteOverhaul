...
data:extend({
  {
    ...
    crafting_categories = {"hand-craft","crafting","crafting-2"},
    crafting_speed = 0.5,
    energy_source =
    {
      type = "electric",
  ...
  },
  {
    ...
    icon = "__CartmenCompleteOverhaul__/graphics/icons/entity/assembling-machine-4.png",
    flags = {"placeable-neutral", "placeable-player", "player-creation"},
    ...
    crafting_categories = {"crafting", "advanced-crafting", "crafting-with-fluid","advanced-crafting-2"},
    crafting_speed = 1.75,
    energy_source =
    {
      type = "electric",
  ...
  },
  {
    ...
    icon = "__CartmenCompleteOverhaul__/graphics/icons/entity/assembling-machine-5.png",
    flags = {"placeable-neutral","placeable-player", "player-creation"},
