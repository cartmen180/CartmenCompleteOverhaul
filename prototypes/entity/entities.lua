data:extend({
  { type = "assembling-machine", name="small-blast-furnace",
    ...
    animation =
    {
	  north = 
	  {
      filename = "__CartmenCompleteOverhaul__/graphics/entity/simple-blast-furnace/b_furnace_small_off.png",
      width = 120,
      height = 120,
      frame_count = 1,
      shift = {0.4, -0.06},
	...
	{
	  {
        ...
        animation =
		{
			filename = "__CartmenCompleteOverhaul__/graphics/entity/simple-blast-furnace/b-furnace-anim-s.png",
				priority = "high",
				frame_count = 10,
				width = 120,
				height = 120,
  ...
  { type = "assembling-machine", name="small-blast-furnace-2",
    ...
    animation =
    {
	  north = 
	  {
      filename = "__CartmenCompleteOverhaul__/graphics/entity/e-simple-blast-furnace/e_b_furnace_small_off.png",
      width = 120,
      height = 120,
      frame_count = 1,
      shift = {0.4, -0.06},
	...
	{
	  {
        ...
        animation =
		{
			filename = "__CartmenCompleteOverhaul__/graphics/entity/e-simple-blast-furnace/e-b-furnace-anim-s.png",
				priority = "high",
				frame_count = 10,
				width = 120,
				height = 120,
  ...
  { type = "assembling-machine", name = "casting-facility",
    ...
    animation =
    {
	  north = 
	  {
      filename = "__CartmenCompleteOverhaul__/graphics/entity/cooler/cooler_off.png",
      width = 120,
      height = 120,
      frame_count = 1,
      shift = {0.4, -0.06},
	...
	{
	  {
        ...
        animation =
		{
			filename = "__CartmenCompleteOverhaul__/graphics/entity/cooler/cooler_anim_e.png",
				priority = "high",
				frame_count = 10,
				width = 120,
				height = 120,
  ...
  { type = "assembling-machine", name = "casting-facility-2",
	...
	animation =
    {
	  north = 
	  {
      filename = "__CartmenCompleteOverhaul__/graphics/entity/cooler-2/cooler_off.png",
      width = 120,
      height = 120,
      frame_count = 1,
      shift = {0.4, -0.06},
	...
	{
	  {
        ...
        animation =
		{
			filename = "__CartmenCompleteOverhaul__/graphics/entity/cooler-2/cooler_anim_e.png",
				priority = "high",
				frame_count = 10,
				width = 120,
				height = 120,
  ...
  --[[{ type = "assembling-machine", name = "mill",
    ...
    animation =
    {
	  north = 
	  {
      filename = "__CartmenCompleteOverhaul__/graphics/entity/mill/crusher_off.png",
      width = 120,
      height = 120,
      frame_count = 1,
      shift = {0.4, -0.06},
	...
	{
	  {
        ...
        animation =
		{
			filename = "__CartmenCompleteOverhaul__/graphics/entity/mill/crusher-anim-s.png",
				priority = "high",
				frame_count = 12,
				width = 120,
				height = 120,
  ...
  { type = "assembling-machine", name = "mill-2",
    ...
    animation =
    {
	  north = 
	  {
      filename = "__CartmenCompleteOverhaul__/graphics/entity/mill-2/crusher_off.png",
      width = 120,
      height = 120,
      frame_count = 1,
      shift = {0.4, -0.06},
	...
	{
	  {
        ...
        animation =
		{
			filename = "__CartmenCompleteOverhaul__/graphics/entity/mill-2/crusher-anim-s.png",
				priority = "high",
				frame_count = 12,
				width = 120,
				height = 120,
  ...
  { type = "assembling-machine", name = "large-blast-furnace",
    ...
    animation =
    {
      filename = "__CartmenCompleteOverhaul__/graphics/entity/blast-furnace/blast-f-on.png",
      priority = "high",
      width = 180,
      height = 220,
      frame_count = 1,
