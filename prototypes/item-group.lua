data:extend({
  ...
  {type = "item-subgroup", name = "cartmen-production", group = "cartmen-5", order = "a"},
  {type = "item-subgroup", name = "cartmen-miners", group = "cartmen-5", order = "b"},
  {type = "item-subgroup", name = "cartmen-assemblers", group = "cartmen-5", order = "c-a"},
  {type = "item-subgroup", name = "cartmen-machine-1", group = "cartmen-5", order = "c-b"},
  ...
  {type = "item-subgroup", name = "cartmen-assembler-modules", group = "cartmen-6", order = "a"},
  {type = "item-subgroup", name = "cartmen-assembler-modules-2", group = "cartmen-6", order = "b"},
})