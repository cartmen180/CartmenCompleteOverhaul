data:extend({
  ...
  { type = "recipe", name = "epoxy-hydrolysis",
    icon = "__CartmenCompleteOverhaul__/graphics/icons/fluid/epoxy-hydrolysis.png",
	category = "chemistry",
	enabled = false,
	energy_required = 3.0,
	ingredients = {{type="fluid",name="epoxy",amount=5},{type="fluid",name="water",amount=5}},
	results = {{type="fluid",name="DEG",amount=6},{type="fluid",name="TEG",amount=4}},
	subgroup = "cartmen-petrolchemics",
	order = "a",
  },  
  { type = "recipe", name = "hydrated-petroleum-gas",
    icon = "__CartmenCompleteOverhaul__/graphics/icons/fluid/hydrated-petroleum-gas.png",
	category = "chemistry",
	enabled = false,
	energy_required = 3,
	ingredients = {{type="fluid",name="petroleum-gas",amount=4},{type="fluid",name="hydrogen",amount=8}},
	results = {{type="fluid",name="hydrated-petroleum-gas",amount=4}},
	subgroup = "cartmen-petrolchemics",
	order = "b-a",
  },
  { type = "recipe", name = "benzene",
    icon = "__CartmenCompleteOverhaul__/graphics/icons/fluid/benzene.png",
	category = "chemistry",
	enabled = false,
	energy_required = 20,
	ingredients = {{type="fluid",name="hydrated-petroleum-gas",amount=15},{type="fluid",name="DEG",amount=4},{"platinum-chloride",1}},
	results = {{type="fluid",name="benzene",amount=15}},
	subgroup = "cartmen-petrolchemics",
	order = "b-b",
  },
  { type = "recipe", name = "vinyl-chloride",
    icon = "__CartmenCompleteOverhaul__/graphics/icons/fluid/vinyl-chloride.png",
	category = "chemistry",
	enabled = false,
	energy_required = 8,
	ingredients = {{type="fluid",name="ethane",amount=5},{type="fluid",name="chlorine",amount=10}},
	results = {{type="fluid",name="vinyl-chloride",amount=5},{type="fluid",name="hydrogen-chloride",amount=5}},
	subgroup = "cartmen-petrolchemics",
	order = "c",
  },
  
  { type = "recipe", name = "pvc-initiator",
    icon = "__CartmenCompleteOverhaul__/graphics/icons/chemical/pvc-initiator.png",
	category = "chemistry",
	enabled = false,
	energy_required = 8,
	ingredients = {{type="fluid",name="hydrogen-peroxide",amount=5},{type="fluid",name="TEG",amount=2}},
	results = {{type="item",name="pvc-initiator",amount=1}},
	subgroup = "cartmen-petrolchemics",
	order = "d",
  },
  { type = "recipe", name = "polyvinyl-chloride",
    icon = "__CartmenCompleteOverhaul__/graphics/icons/fluid/polyvinyl-chloride.png",
	category = "chemistry",
	enabled = false,
	energy_required = 12,
	ingredients = {{type="fluid",name="vinyl-chloride",amount=8},{type="fluid",name="water",amount=5},{type="item",name="pvc-initiator",amount=1}},
	results = {{type="fluid",name="polyvinyl-chloride",amount=4}},
	subgroup = "cartmen-petrolchemics",
	order = "e",
  },
