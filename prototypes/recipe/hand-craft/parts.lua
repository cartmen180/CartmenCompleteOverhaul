data:extend({
  ...
  { type = "recipe", name = "copper-parts",
	...
	enabled = false,
	energy_required = 1.0,
	ingredients = {{"copper-gear-wheel", 10},{"copper-shaft", 5},{"copper-bolts-screws", 10}},
  ...
  { type = "recipe", name = "bronze-parts",
	...
	enabled = false,
	energy_required = 1.0,
	ingredients = {{"bronze-gear-wheel", 10},{"bronze-shaft", 5},{"bronze-bolts-screws", 10}},
  ...
  { type = "recipe", name = "iron-parts",
	...
	enabled = false,
	energy_required = 1.0,
	ingredients = {{"iron-gear-wheel", 10},{"iron-stick", 5},{"iron-bolts-screws", 10}},
